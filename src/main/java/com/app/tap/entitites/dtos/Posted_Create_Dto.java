...
public class Posted_Create_Dto implements Serializable {
    ...
    public Posted_Create_Dto(Integer uuserId, String title_pictured, String extension_pictured, String base64_pictured, String name_posted, String description, String category, Boolean posted_fav) {
        UuserId = uuserId;
